  ...
  async getPublicCmsData(forceRefresh = false) {
    ...
    try {
      ...
      const result = {
        ...
        registrationFeeAmount: settingsMap.registrationFeeAmount ? Number(settingsMap.registrationFeeAmount) : 211.30,
        registrationFeeNote: `₹ ${Number(settingsMap.registrationFeeAmount || 211.30).toFixed(2)}/- (केवल आवेदन प्रक्रिया हेतु)`,
