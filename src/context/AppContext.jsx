      ...
      if (liveCms) {
        setCms(prev => ({
          ...
          downloads: liveCms.downloads?.length ? liveCms.downloads.map(d => ({
            ...
            title_hi: d.title_hi || d.titleHi,
            titleEn: d.title_en || d.titleEn,
            titleHi: d.title_hi || d.titleHi,
            category_en: d.category_en || d.categoryEn,
            category_hi: d.category_hi || d.categoryHi,
            categoryEn: d.category_en || d.categoryEn,
            categoryHi: d.category_hi || d.categoryHi,
            format: d.format || 'PDF',
            size: d.size_display || d.size,
            size_display: d.size_display || d.size,
            file_url: d.file_url || d.fileUrl,
            fileUrl: d.file_url || d.fileUrl,
            preview_image_url: d.preview_image_url || d.previewImageUrl,
            previewImageUrl: d.preview_image_url || d.previewImageUrl,
            preview_image_page2_url: d.preview_image_page2_url || d.previewImagePage2Url,
            previewImagePage2Url: d.preview_image_page2_url || d.previewImagePage2Url,
            doc_number: d.doc_number || d.docNumber,
            docNumber: d.doc_number || d.docNumber,
            authority: d.authority,
            description_en: d.description_en || d.descriptionEn,
            description_hi: d.description_hi || d.descriptionHi,
